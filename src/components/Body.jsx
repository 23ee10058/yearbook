...
const Body = (props) => {
  ...
  useEffect(() => {
    ...
    if (super_container) {
      if (props.count % 2 != 0) {
        super_container.classList.add(styles.sup_light);
        container.classList.add(styles.container_light);

        
        console.log(super_container.classList)
      } 
      else {
        super_container.classList.remove(styles.sup_light);
      }
    }
  }, [props.count]);
  return (
